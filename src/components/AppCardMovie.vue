        ...
        <div class="flip-card-inner">
            ...
            <div class="flip-card-back mt-5" :class="{ 'fallback-cover-back': !myMovie.poster_path }">
                <ul>
                    ...
                    <li class="mt-2">Voto: 
                        <i v-for="n in 5" :key="n" class="fa-star" :class="{ 'fa-solid': n <= Math.round(myMovie.vote_average / 2), 'fa-regular': n > Math.round(myMovie.vote_average / 2) }" style="color: #ffff00;"></i>
                    </li>
                </ul>
            </div>
        </div>
